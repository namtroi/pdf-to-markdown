...
describe('functions: hasUpperCaseCharacterInMiddleOfWord', () => {
    ...
    it('with numbers', () => {
        ...
        expect(hasUpperCaseCharacterInMiddleOfWord("High 5 or tWo down")).toBe(true);
...
describe('functions: charCodeArray', () => {
    ...
    it('Convert Back', () => {
        expect(String.fromCharCode(...charCodeArray("word"))).toBe("word");
        expect(String.fromCharCode(...charCodeArray("WORD"))).toBe("WORD");
        expect(String.fromCharCode(...charCodeArray("a word"))).toBe("a word");
    });
...
describe('functions: normalizedCharCodeArray', () => {
    ...
    it('No Change', () => {
        expect(String.fromCharCode(...normalizedCharCodeArray("WORD"))).toBe("WORD");
        expect(String.fromCharCode(...normalizedCharCodeArray("WORD23"))).toBe("WORD23");
    });
    ...
    it('RemoveWhiteSpace', () => {
        expect(String.fromCharCode(...normalizedCharCodeArray("A WORD"))).toBe("AWORD");
        expect(String.fromCharCode(...normalizedCharCodeArray("SOME LITTLE SENTENCE."))).toBe("SOMELITTLESENTENCE");
    });

    it('All', () => {
        expect(String.fromCharCode(...normalizedCharCodeArray("a word"))).toBe("AWORD");
        expect(String.fromCharCode(...normalizedCharCodeArray("WoRd 4 u"))).toBe("WORD4U");
        expect(String.fromCharCode(...normalizedCharCodeArray("Some little sentence."))).toBe("SOMELITTLESENTENCE");
    });
...
describe('functions: wordsMatch', () => {
    ...
    it('Match', () => {
        ...
        expect(wordMatch('inStruCtionS for the full Moon proCeSS', 'Instructions for the Full Moon Process')).toBe(1.0);
    });
